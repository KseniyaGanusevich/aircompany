...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        boolean containsTransport = transportMilitaryPlanes.stream()
                .anyMatch(militaryPlane -> militaryPlane.getType() == MilitaryType.TRANSPORT);
        Assert.assertTrue(containsTransport);
    }
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        boolean containsBomber = bomberMilitaryPlanes.stream()
                .anyMatch(militaryPlane -> militaryPlane.getType() == MilitaryType.BOMBER);
        Assert.assertTrue(containsBomber);
    }
